    ...
    <form method="post" action="aksi_barang.php">
        ...
        <table class="table">
            <tr>
                <td>Nama Barang</td>
                <td>:</td>
                <td><input type="text" name="nb" id="nb" value="<?= $d['nama_barang'] ?>" class="form-control"></td>
            </tr>
            <tr>
                <td>Deskripsi</td>
                <td>:</td>
                <td><input type="text" name="deskripsi" id="deskripsi" value="<?= $d['deskripsi'] ?>" class="form-control"></td>
            </tr>
            <tr>
                <td>Harga</td>
                <td>:</td>
