    ...
    <form method="post" action="aksi_kasir.php">
        ...
        <table class="table">
            <tr>
                <td>Email</td>
                <td>:</td>
                <td><input type="text" class="form-control" name="e" id="e" value="<?= $d['email'] ?>"></td>
            </tr>
                     <tr>
                <td>username</td>
                <td>:</td>
                <td><input type="text" class="form-control" name="un" id="un" value="<?= $d['username'] ?>"></td>
            </tr>
                     <tr>
                <td>Password</td>
                <td>:</td>
                <td><input type="text" class="form-control" name="pw" id="pw" value="<?= $d['passwd'] ?>"></td>
            </tr>
             <tr>
                <td>Peran</td>
                <td>:</td>
