                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                User</div>
                                                <?php 
                                                    $a = mysqli_query($db, "SELECT * FROM kasir");
                                                    $b = mysqli_num_rows($a);
                                                ?>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Barang</div>
                                                <?php 
                                                    $c = mysqli_query($db, "SELECT * FROM barang");
                                                    $d = mysqli_num_rows($c);
                                                ?>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Transaksi</div>
                                                <?php 
                                                    $e = mysqli_query($db, "SELECT SUM(total) as total FROM transaksi");
                                                    $f = mysqli_fetch_array($e);
                                                ?>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rp. <?= $f['total'] ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-calendar fa-2x text-gray-300"></i>
                                        </div>
