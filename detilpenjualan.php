                ...
                <div>
					<br/>	
						<table width="100%" class="table table-striped table-hover"  >
							...
							<?php
                                // echo $_GET['id'];
								$b = mysqli_query($db, "SELECT a.*,b.nama_barang,c.code FROM transaksi_detail a 
                                JOIN barang b ON a.id_barang = b.id_barang
                                JOIN transaksi c ON a.id_tarnsaksi = c.id WHERE a.id_tarnsaksi = ".@$_GET['id']);
								$no = 1;
								while ($c = mysqli_fetch_array($b))
									{
										...
										echo "<td align='center'>$c[jumlah]</td>";
